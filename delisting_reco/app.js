...
if (typeof Vue === 'undefined') {
    ...
    document.getElementById('app').innerHTML = '<div class="container py-2 px-4"><div class="rates-card"><div class="bd"><h4>Error</h4><p>Vue.js failed to load. Please check your internet connection.</p></div></div></div>';
}
                        ...
                        <div class="col-12">
                            <div class="rates-card">
                                <div class="bd">
                                    ...
                                    <p>Please check that hl_delisting_data.json exists in the delisting_reco directory.</p>
                                </div>
                            </div>
                        </div>
                    </div>
