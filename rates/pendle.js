...
const Pendle = (function () {
  ...
  function render(markets) {
    ...
    if (window.markFreshness) window.markFreshness("pendleUpdatedBadge");
    else elUpdated.textContent = "Live · " + stamp();
  }
  ...
  async function refresh() {
    try {
      ...
      if (window.markFreshnessError) window.markFreshnessError("pendleUpdatedBadge", "feed error");
      else elUpdated.textContent = "Stale · feed error";
    }
  }
