...
const HypeBnb = (function () {
  ...
  function renderChart1() {
    ...
    if (window.markFreshness) window.markFreshness("chart1Badge");
    else document.getElementById("chart1Badge").textContent = "Live · " + stamp();
  }
  ...
  function renderChart2() {
    ...
    if (window.markFreshness) window.markFreshness("chart2Badge");
    else document.getElementById("chart2Badge").textContent = "Live · " + stamp();
  }
  ...
  function renderChart3() {
    ...
    if (window.markFreshness) window.markFreshness("chart3Badge");
    else document.getElementById("chart3Badge").textContent = "Live · " + stamp();
  }
  ...
  function renderChart4() {
    ...
    if (window.markFreshness) window.markFreshness("chart4Badge");
    else document.getElementById("chart4Badge").textContent = "Live · " + stamp();
  }
  ...
  function renderChart5() {
    ...
    if (window.markFreshness) window.markFreshness("chart5Badge");
    else document.getElementById("chart5Badge").textContent = "Live · " + stamp();
  }
  ...
  function renderChart6() {
    ...
    if (window.markFreshness) window.markFreshness("chart6Badge");
    else document.getElementById("chart6Badge").textContent = "Live · " + stamp();
  }
